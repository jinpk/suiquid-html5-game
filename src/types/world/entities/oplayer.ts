...
export interface IOPlayer extends ISprite, IEnemyTarget {
    /**
    ...
    /**
     * Manual Key to move player
     * @param targetDirection - key board
     * 
     */
    setTargetDirection(targetDirection: Phaser.Math.Vector2): void
    /**
     * Manual Key to move player
     * @param xMD - MovementDirection for x axis
     * @param yMD - MovementDirection for y axis
     */
    setDirectionMovement(xMD: MovementDirection, yMD: MovementDirection): void
}
